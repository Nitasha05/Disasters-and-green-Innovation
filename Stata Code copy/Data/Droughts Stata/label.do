import delimited "/Users/nitashajhala/Desktop/Stata Code/Data/Droughts Stata/7_Drought_panel_combined_instruments_updated.csv"
...
gen ratio_drought_granted = _drought_granted_count / exp(control_total_patents)
lab var ratio_drought_granted "Share of drought patents (granted)"
...
by country: gen lag_drought_k_stock = _drought_k_stock[_n-1]
lab var lag_drought_k_stock "Log drought adaptation knowledge stock (year t-1)"
order lag_drought_k_stock, after(_drought_k_stock)
lab var _drought_k_stock "Log drought adaptation knowledge stocks"
...
lab var r10_drought "Drought indicator (dummy)"
lab var drought "Drought indicator (not lagged)"
order difmonth drought r10_difmonth r10_drought , after(_drought_k_stock)
lab var _drought_total_count "Total drought adaptation patents"
lab var _drought_granted_count "Drought adaptation patents (granted)"
lab var _drought_granted_family_ge_2_cou "Drought adaptation patents (famsiz>=2)"
...
drop v1 v2 v3 v4 v5 v16 polity_x combi abs_diff dif_temp flood r10_lpop r10_polity r10_low r10_middle r10_high r10_damage_cor r10_damage_gdp r10_combi r10_abs_diff r10_dif_temp r10_flood r10_disindex r10_disindexla r10_indexla r10_dindex r10_region r10_income_group
