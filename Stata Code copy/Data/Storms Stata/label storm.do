import delimited "/Users/nitashajhala/Desktop/Stata Code/Data/Storms Stata/3_Storm_panel_combined_instruments_updated.csv"
...
gen ratio_storm_granted = _storm_granted_count / exp(control_total_patents)
lab var ratio_storm_granted "Share of storm patents (granted)"
...
by country: gen lag_storm_k_stock = _storm_k_stock[_n-1]
lab var lag_storm_k_stock "Log storm adaptation knowledge stock (year t-1)"
lab var _storm_k_stock "Log storm adaptation knowledge stocks"
lab var e_control_total_patents " Total Patent applications"
lab var r10_difmonth "Precipitation anomaly"
lab var difmonth "Precipitation Anomaly (not lagged)"
lab var r10_combi "Maximum wind speed indicator"
lab var combi "Maximum wind speed (not lagged)"
order combi difmonth r10_combi r10_difmonth , after(_storm_k_stock)
lab var _storm_total_count "Total storm adaptation patents"
lab var _storm_granted_count "Storm adaptation patents (granted)"
lab var _storm_granted_family_ge_2_count "Storm adaptation patents (famsiz>=2)"
...
drop v1 v2 v3 v4 v5 v16 polity_x abs_diff dif_temp flood r10_lpop r10_polity r10_low r10_middle r10_high r10_damage_cor r10_damage_gdp r10_abs_diff r10_dif_temp r10_flood r10_disindex r10_disindexla r10_indexla r10_dindex r10_region r10_income_group drought r10_drought 
...
xtset panelvar year
order lag_storm_k_stock, after(_storm_k_stock)
...
save "/Users/nitashajhala/Desktop/Stata Code/Data/Storms Stata/data_storm.dta"
