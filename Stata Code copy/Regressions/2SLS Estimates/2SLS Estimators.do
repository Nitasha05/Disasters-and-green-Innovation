...
drop dam_hat death_hat dam_hat1 dam_hat2 dam_hat3 dam_hat4 dam_hat5 dam_hat6 dam_hat7 dam_hat8 dam_hat9 dam_hat10 death_hat1 death_hat2 death_hat3 death_hat4 death_hat5 death_hat6 death_hat7 death_hat8 death_hat9 death_hat10
Deaths
...
#Deaths
use "/Users/nitashajhala/Desktop/Stata Code/Data/Storms Stata/data_storm.dta"
eststo: xtpoisson _storm_granted_count death_hat1 death_hat2 death_hat3 death_hat4 death_hat5 death_hat6 death_hat7 lag_storm_k_stock gdp_per_capita_lag polity control_total_patents v6-v26, fe vce(robust)
lincom + death_hat1 + death_hat2 + death_hat3 + death_hat4 + death_hat5 + death_hat6 + death_hat7 
estadd scalar Cumulative = r(estimate)

#Damages
eststo: xtpoisson _storm_granted_count  dam_hat1 dam_hat2 dam_hat3 dam_hat4 dam_hat5 dam_hat6 dam_hat7 lag_storm_k_stock gdp_per_capita_lag polity control_total_patents v6-v26, fe vce(robust)
...
use "/Users/nitashajhala/Desktop/Stata Code/Data/Droughts Stata/data_drought.dta"
#Deaths
eststo: xtpoisson _drought_granted_count death_hat1 death_hat2 death_hat3 death_hat4 death_hat5 death_hat6 death_hat7 lag_drought_k_stock gdp_per_capita_lag polity control_total_patents v6-v26, fe vce(robust)
lincom + death_hat1 + death_hat2 + death_hat3 + death_hat4 + death_hat5 + death_hat6 + death_hat7 
estadd scalar Cumulative = r(estimate)

#Damages
eststo: xtpoisson _drought_granted_count  dam_hat1 dam_hat2 dam_hat3 dam_hat4 dam_hat5 dam_hat6 dam_hat7 lag_drought_k_stock gdp_per_capita_lag polity control_total_patents v6-v26, fe vce(robust)
lincom  + dam_hat1 + dam_hat2 + dam_hat3 + dam_hat4 + dam_hat5 + dam_hat6 + dam_hat7
estadd scalar Cumulative = r(estimate)
clear
...
use "/Users/nitashajhala/Desktop/Stata Code/Data/Floods Stata/data_flood.dta"
#Deaths
eststo: xtpoisson _flood_granted_count death_hat1 death_hat2 death_hat3 death_hat4 death_hat5 death_hat6 death_hat7 lag_flood_k_stock gdp_per_capita_lag polity control_total_patents v6-v26, fe vce(robust)
lincom + death_hat1 + death_hat2 + death_hat3 + death_hat4 + death_hat5 + death_hat6 + death_hat7 
estadd scalar Cumulative = r(estimate)

#Damages
eststo: xtpoisson _flood_granted_count  dam_hat1 dam_hat2 dam_hat3 dam_hat4 dam_hat5 dam_hat6 dam_hat7 lag_flood_k_stock gdp_per_capita_lag polity control_total_patents v6-v26, fe vce(robust)
lincom  + dam_hat1 + dam_hat2 + dam_hat3 + dam_hat4 + dam_hat5 + dam_hat6 + dam_hat7
estadd scalar Cumulative = r(estimate)
clear
...
use "/Users/nitashajhala/Desktop/Stata Code/Data/ExTemp Stata/data_extemp.dta"
#Deaths
eststo: xtpoisson _extemp_granted_count death_hat1 death_hat2 death_hat3 death_hat4 death_hat5 death_hat6 death_hat7 lag_extemp_k_stock gdp_per_capita_lag polity control_total_patents v6-v26, fe vce(robust)
lincom + death_hat1 + death_hat2 + death_hat3 + death_hat4 + death_hat5 + death_hat6 + death_hat7 
estadd scalar Cumulative = r(estimate)

#Damages
eststo: xtpoisson _extemp_granted_count  dam_hat1 dam_hat2 dam_hat3 dam_hat4 dam_hat5 dam_hat6 dam_hat7 lag_extemp_k_stock gdp_per_capita_lag polity control_total_patents v6-v26, fe vce(robust)
lincom  + dam_hat1 + dam_hat2 + dam_hat3 + dam_hat4 + dam_hat5 + dam_hat6 + dam_hat7
estadd scalar Cumulative = r(estimate)
clear
...
#Deaths
use "/Users/nitashajhala/Desktop/Stata Code/Data/Storms Stata/data_storm.dta"
eststo: xtpoisson granted_count lag_k_stock _storm_granted_count death_hat1 death_hat2 death_hat3 death_hat4 death_hat5 death_hat6 death_hat7 lag_storm_k_stock gdp_per_capita_lag polity control_total_patents v6-v26, fe vce(robust)
lincom + death_hat1 + death_hat2 + death_hat3 + death_hat4 + death_hat5 + death_hat6 + death_hat7 
estadd scalar Cumulative = r(estimate)

#Damages
eststo: xtpoisson granted_count lag_k_stock _storm_granted_count  dam_hat1 dam_hat2 dam_hat3 dam_hat4 dam_hat5 dam_hat6 dam_hat7 lag_storm_k_stock gdp_per_capita_lag polity control_total_patents v6-v26, fe vce(robust)
lincom  + dam_hat1 + dam_hat2 + dam_hat3 + dam_hat4 + dam_hat5 + dam_hat6 + dam_hat7
estadd scalar Cumulative = r(estimate)
clear
...
use "/Users/nitashajhala/Desktop/Stata Code/Data/Droughts Stata/data_drought.dta"
#Deaths
eststo: xtpoisson granted_count lag_k_stock _drought_granted_count death_hat1 death_hat2 death_hat3 death_hat4 death_hat5 death_hat6 death_hat7 death_hat8 death_hat9 death_hat10 lag_drought_k_stock gdp_per_capita_lag polity control_total_patents v6-v26, fe vce(robust)
lincom + death_hat1 + death_hat2 + death_hat3 + death_hat4 + death_hat5 + death_hat6 + death_hat7 + death_hat8 + death_hat9 + death_hat10
estadd scalar Cumulative = r(estimate)

#Damages
eststo: xtpoisson granted_count lag_k_stock _drought_granted_count  dam_hat1 dam_hat2 dam_hat3 dam_hat4 dam_hat5 dam_hat6 dam_hat7 dam_hat8 lag_drought_k_stock gdp_per_capita_lag polity control_total_patents v6-v26, fe vce(robust)
...
use "/Users/nitashajhala/Desktop/Stata Code/Data/Floods Stata/data_flood.dta"
#Deaths
eststo: xtpoisson granted_count lag_k_stock _flood_granted_count death_hat1 death_hat2 death_hat3 death_hat4 death_hat5 death_hat6 death_hat7 death_hat8 death_hat9 death_hat10 lag_flood_k_stock gdp_per_capita_lag polity control_total_patents v6-v26, fe vce(robust)
lincom + death_hat1 + death_hat2 + death_hat3 + death_hat4 + death_hat5 + death_hat6 + death_hat7 + death_hat8 + death_hat9 + death_hat10
estadd scalar Cumulative = r(estimate)

#Damages
eststo: xtpoisson granted_count lag_k_stock _flood_granted_count  dam_hat1 dam_hat2 dam_hat3 dam_hat4 dam_hat5 dam_hat6 dam_hat7 dam_hat8 dam_hat9 dam_hat10 lag_flood_k_stock gdp_per_capita_lag polity control_total_patents v6-v26, fe vce(robust)
...
use "/Users/nitashajhala/Desktop/Stata Code/Data/ExTemp Stata/data_extemp.dta"
#Deaths
eststo: xtpoisson granted_count lag_k_stock _extemp_granted_count death_hat1 death_hat2 death_hat3 death_hat4 death_hat5 death_hat6 death_hat7 death_hat8 death_hat9 death_hat10  lag_extemp_k_stock gdp_per_capita_lag polity control_total_patents v6-v26, fe vce(robust)
lincom + death_hat1 + death_hat2 + death_hat3 + death_hat4 + death_hat5 + death_hat6 + death_hat7 + death_hat8 + death_hat9 + death_hat10
estadd scalar Cumulative = r(estimate)

#Damages
eststo: xtpoisson granted_count lag_k_stock _extemp_granted_count  dam_hat1 dam_hat2 dam_hat3 dam_hat4 dam_hat5 dam_hat6 dam_hat7 dam_hat8 dam_hat9 dam_hat10 lag_extemp_k_stock gdp_per_capita_lag polity control_total_patents v6-v26, fe vce(robust)
lincom  + dam_hat1 + dam_hat2 + dam_hat3 + dam_hat4 + dam_hat5 + dam_hat6 + dam_hat7 + dam_hat8 + dam_hat9 + dam_hat10
estadd scalar Cumulative = r(estimate)
clear
...
esttab using "Mitigation_2SLSestimates.tex", keep(lag_k_stock _storm_granted_count _drought_granted_count _flood_granted_count _extemp_granted_count  dam_hat1 dam_hat2 dam_hat3 dam_hat4 dam_hat5 dam_hat6 dam_hat7 death_hat1 death_hat2 death_hat3 death_hat4 death_hat5 death_hat6 death_hat7 lag_storm_k_stock lag_flood_k_stock lag_extemp_k_stock lag_drought_k_stock gdp_per_capita_lag polity control_total_patents) varlabels(dam_hat Year_t dam_hat1 Year_t-1 dam_hat2 Year_t-2 dam_hat3 Year_t-3 dam_hat4 Year_t-4 dam_hat5 Year_t-5 dam_hat6 Year_t-6 dam_hat7 Year_t-7  dam_hat8 Year_t-8 dam_hat9 Year_t-9 dam_hat10 Year_t-10 Year_t death_hat1 Year_t-1 death_hat2 Year_t-2 death_hat3 Year_t-3 death_hat4 Year_t-4 death_hat5 Year_t-5 death_hat6 Year_t-6 death_hat7 Year_t-7 death_hat8 Year_t-8 death_hat9 Year_t-9 death_hat10 Year_t-10 lag_k_stock Green_technology_knowledge_stocks(Year_t-1)  gdp_per_capita_lag Log_Gdp_per_capita_lag polity Institution_index control_total_patents Log_patent_applications _storm_granted_count Storm_adaptation_patents(granted) lag_storm_k_stock Storm_adaptation_knowledge_stocks(Year_t-1) _flood_granted_count Flood_adaptation_patents(granted) lag_flood_k_stock Flood_adaptation_knowledge_stocks(Year_t-1) _extemp_granted_count ExtremeTemperature_adaptation_patents(granted) lag_extemp_k_stock ExtremeTemperature_adaptation_knowledge_stocks(Year_t-1)  _drought_granted_count Drought_adaptation_patents(granted)  lag_drought_k_stock Drought_adaptation_knowledge_stocks(Year_t-1)) replace b(3) se(3) mtitle("Deaths" "Damages" "Deaths" "Damages" "Deaths" "Damages" "Deaths" "Damages") mgroups( "Storm" "Drought" "Flood" "Extreme Temperature", pattern(1 0  1 0  1 0  1 0 )) label star(* 0.10 ** 0.05 *** 0.01) booktabs alignment(D{.}{.}{-1}) title(Green innovation response to extreme weather shocks (2SLS estimates) \label{reg122}) addnotes("Notes : Deaths are measured in thousands and economic damages are measures in billions US\$ at 2015 price") eform stats(Cumulative ll  N, labels( "Cumulative effect" " Log-liklihood" "Observations"))
est clear
